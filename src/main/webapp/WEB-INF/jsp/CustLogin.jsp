...
<body>
    ...
    <div class="container mt-4">
        <div style=" max-width: 306px; position: relative;
    left: 411px; text-align: center;">
            <img src="../../static/images/pngwing.com.png" alt="" style="width: 80px;">
        <h3 style="font-weight: bold;
       
   ">YOUR ACCOUNT FOR EVERYTHING NIKE </h3>
    </div>
